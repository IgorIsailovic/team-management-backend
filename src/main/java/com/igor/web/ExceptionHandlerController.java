...
public class ExceptionHandlerController {
    ...
    public ErrorAttributes errorAttributes() {
		...
		return new DefaultErrorAttributes() /*
											 * {
											 * 
											 * @Override public Map<String, Object> getErrorAttributes(WebRequest
											 * requestAttributes, boolean includeStackTrace) { Map<String, Object>
											 * errorAttributes = super.getErrorAttributes(requestAttributes,
											 * includeStackTrace); errorAttributes.remove("exception"); return
											 * errorAttributes; } }
											 */;
    }
